...
import imgui.moulberry92.assertion.ImAssertCallback;
import imgui.moulberry92.binding.annotation.ArgValue;
import imgui.moulberry92.binding.annotation.ArgVariant;
import imgui.moulberry92.binding.annotation.BindingMethod;
import imgui.moulberry92.binding.annotation.BindingSource;
import imgui.moulberry92.binding.annotation.OptArg;
...
import imgui.moulberry92.type.ImDouble;
import imgui.moulberry92.type.ImFloat;
import imgui.moulberry92.type.ImInt;
import imgui.moulberry92.type.ImLong;
import imgui.moulberry92.type.ImShort;
...
public class ImGui {
    private static final String LIB_NAME = "imgui-moulberry92-java64";
    private static final String LIB_TMP_DIR_PREFIX = "imgui-moulberry92-java-natives";
    ...
    static {
        ...
        if (extractedLibAbsPath != null) {
            ...
            throw new RuntimeException("Unable to load from classpath");
        }
    ...
    private static String resolveFullLibName() {
        ...
        return libPrefix + LIB_NAME + libSuffix;
    }
    ...
    private static Optional<String> getVersionString() {
        ...
        try (InputStream is = ImGui.class.getResourceAsStream("/imgui/moulberry92/imgui-java.properties")) {
            if (is != null) {
                properties.load(is);
    ...
    */
    ...
    private static native void nInitInputTextData(); /*
        jclass jInputDataClass = env->FindClass("imgui/moulberry92/type/ImString$InputData");
        ...
        jclass jImString = env->FindClass("imgui/moulberry92/type/ImString");
        jImStringResizeInternalMID = env->GetMethodID(jImString, "resizeInternal", "(I)[B");

        jclass jCallback = env->FindClass("imgui/moulberry92/callback/ImGuiInputTextCallback");
